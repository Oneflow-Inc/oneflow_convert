...
**oneflow-onnx: OneFlow -> ONNX model conversion tool**
...
- [Introduction](#introduction)
  ...
  - [ONNX-related Libraries](#onnx-related-libraries)
  - [Introduction to oneflow-onnx](#introduction-to-oneflow-onnx)
- [Install oneflow-onnx](#install-oneflow-onnx)
  - [Environment Dependencies](#environment-dependencies)
  - [Installation Methods](#installation-methods)
- [How to Use oneflow-onnx](#how-to-use-oneflow-onnx)
  - [Basic Usage](#basic-usage)
  - [Considerations when Exporting Models](#considerations-when-exporting-models)
- [An Example of Usage](#an-example-of-usage)
  - [Export as ONNX Model](#export-as-onnx-model)
...
### Introduction to oneflow-onnx
oneflow-onnx is a model conversion tool provided by OneFlow team to support exporting OneFlow static graph models to ONNX models.  At present oneflow-onnx supports more than 80 kinds of OneFlow OPs exported as ONNX OPs. For detalis, refer to [list of OP supported by OneFlow2ONNX](https://github.com/Oneflow-Inc/oneflow_convert/blob/main/docs/oneflow2onnx/op_list.md)。Currently, oneflow-onnx is fully capable of exporting ONNX Opset10, and parts of OneFlow operator can transform ONNX Opsets that are in lower order. Please refer to [OneFlow2ONNX Operator Lists](docs/oneflow2onnx/op_list.md) for more information. Common models that have passed tests can be referred to [OneFlow2ONNX Model List](docs/oneflow2onnx/oneflow2onnx_model_zoo.md).
...
To export OneFlow static graph model as ONNX model, just call `export_onnx_model` function.
