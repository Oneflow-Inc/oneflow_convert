...
class IResNet(nn.Module):
    ...
    def __init__(
        self, block, layers, dropout=0, num_features=512, zero_init_residual=False, groups=1, width_per_group=64, replace_stride_with_dilation=None, fp16=False,
    ):
...
def test_resnet50():
    ...
    convert_to_onnx_and_check(model_graph, onnx_model_path="/tmp", print_outlier=True)
